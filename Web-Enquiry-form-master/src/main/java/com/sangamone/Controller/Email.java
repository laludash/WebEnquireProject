...
public class Email {
	public static void newStudent(String ecompany, String ename, String email, String econtactno,String ecourse,String emessage ) {
		try {
			//riteshkumaryadav.sangamone@gmail.com
			//gecjksaprmccbnnk
			String from = "laluprasaddash23.sangamone@gmail.com";
			String pass="oagagbgdndpaxhsw";
			String to ="ckuthyar@gmail.com";
			String host="smtp.gmail.com";
             //String to =email:
			String cc= "riteshkumaryadav.sangamone@gmail.com,laluprasaddash23.sangamone@gmail.com,asharaniv.sangamone@gmail.com";
